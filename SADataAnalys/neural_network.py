...
from tensorflow.keras.models import Sequential, load_model, GlobalAveragePooling1D
...
with zipfile.ZipFile(zip_file_path) as z:
    with z.open(csv_file_name) as csv_file:
        ...
        labels = df[0].astype(str) # First column of csv
...
# Figure out activation whatever the hell that means
